...
void main() {
  ...
  StudentDashboardSnapshot buildDashboardSnapshot() {
    return StudentDashboardSnapshot(
      ...
      libraryResources: DemoData.libraryResources,
    );
  }
      ...
      ProviderScope(
        overrides: [
          dashboardSnapshotProvider.overrideWithValue(
            AsyncData(buildDashboardSnapshot()),
          ),
        ],
  ...
  testWidgets('resources library renders folders and list without overflow', (
    ...
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: const MaterialApp(home: ResourcesLibraryScreen()),
      ),
    );
    await tester.pumpAndSettle();
